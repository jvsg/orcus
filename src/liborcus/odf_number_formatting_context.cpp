...
public:
    ...
    const pstring& get_country_code() const { return m_country_code;}
    bool is_volatile() const { return m_volatile;}
    const pstring& get_language() const { return m_language;}
};
...
public:
    ...
    void operator() (const xml_token_attr_t& attr)
    {
        switch (attr.name)
        {
            ...
            case XML_min_integer_digits:
                m_min_int_digits = boost::lexical_cast<size_t>(attr.value.str());
            break;
            default:
                ;
        }
    ...
    const bool is_grouped() const { return m_grouping;}
...
public:
    ...
    void operator() (const xml_token_attr_t& attr)
    {
        switch(attr.name)
        {
            ...
            case XML_min_exponent_digits:
                m_min_exp_digits = boost::lexical_cast<size_t>(attr.value.str());
            break;
            case XML_min_integer_digits:
                m_min_int_digits = boost::lexical_cast<size_t>(attr.value.str());
            break;
    ...
    const size_t& get_decimal_places() const { return m_decimal_places;}
    const bool is_grouped() const { return m_grouping;}
    const size_t& get_min_exp_digits() const { return m_min_exp_digits;}
    const size_t& get_min_int_digits() const { return m_min_int_digits;}
};
...
public:
    ...
    const pstring& get_style_name() const { return m_style_name;}
    const bool is_volatile() const { return m_volatile;}
};
...
public:
    ...
    const bool has_long() const { return m_style_name;}
    const bool is_textual() const { return m_textual;}
};
    ...
    void operator() (const xml_token_attr_t& attr)
    {
        switch(attr.name)
        {
            ...
            case XML_min_numerator_digits:
                m_min_num_digits = boost::lexical_cast<size_t>(attr.value.str());
            break;
...
public:
    ...
    const pstring& get_color() const { return m_color;}
    const bool has_color() const { return !color_absent;}
};
...
public:
    ...
    const string& get_sign() const { return m_sign;}
    const bool has_map() const { return m_has_map;}
};
